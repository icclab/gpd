...
class GpdGrasps(object):
    ...
    def __init__(self, max_messages=8):
        ...
        rospy.Subscriber("/summit_xl/arm_camera/depth_registered/points", PointCloud2, self.cloud_callback)
       # rospy.Subscriber("/summit_xl/front_rgbd_camera/depth/points", PointCloud2, self.cloud_callback)
    ...
    def generate_cloud_indexed_msg(self):
      ...
      #  header.frame_id = "xtion_rgb_optical_frame"
        ...
        header.frame_id = "arm_camera_color_optical_frame"
